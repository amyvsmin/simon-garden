...
- ⏸ 擱置：想挖借鏡點時，看 obsidian-llm-wiki 審核階段「拒絕的文章帶回饋重生成」迴圈——KW γ Step 5c 目前是子代理一次性挑錯、沒有帶回饋自動重生成的閉環〔AI 推論〕。
- ⏸ 擱置：Substack 寫作角度「我自己造了一個 Karpathy 說的 LLM Wiki」，用自建 KW γ 對照這套開源工具〔AI 推論〕。
