...
<p align="center"><img src="assets/covers/2026-04-29-itron-power-conditioner-attack-cover.png" alt="封面圖" width="400"></p>

## 核心概念

- [[power-conditioner]]：直流電源調節器，負責穩定電壓供應的硬體設備。現代電源調節器內建可程式化韌體，但它運作在作業系統層之下，代表傳統防毒軟體和 EDR 完全看不到它的狀態。這種低可見度讓它成為攻擊者潛伏的理想藏身處。
- [[firmware-attack-surface]]：韌體層是傳統端點偵測工具（EDR、防毒）監控不到的盲區。攻擊者如果成功植入韌體後門，可以長期潛伏而不被發現，甚至能影響硬體效能、觸發關機、造成實體損壞。本案中意法半導體的可程式化電源設備已累積數十筆 CVE，顯示韌體正成為資安的新戰場。
- [[critical-infrastructure]]：電網、水網、天然氣等維持社會運作的公共服務系統。傳統資安關注的是 IT 層（伺服器、網路），但本案顯示風險已經下沉到 OT（營運技術）甚至電力硬體層。Itron 一家公司就管理 1.12 億個端點，涵蓋電、水、天然氣三大基礎設施，一旦被攻破影響範圍極大。
- [[supply-chain-risk]]：韌體也會繼承軟體供應鏈的風險。電源調節器用的韌體可能引用第三方程式庫，這些程式庫的漏洞會連帶影響所有使用它的設備。本案中 CVE 揭露的速度令人擔憂，代表過去被忽視的韌體供應鏈正在被系統性地檢視，未來會有更多漏洞浮出水面。
- [[secure-boot]]：安全開機機制，確保設備啟動時只載入經過密碼簽署的韌體，防止被竄改過的韌體被植入。搭配密碼簽署、網路分割、持續監控等措施，是目前抵禦韌體層攻擊的核心防線。
