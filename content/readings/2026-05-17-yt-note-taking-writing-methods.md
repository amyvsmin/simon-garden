...
impact: medium
created: 2026-05-18
tldr: "YT 影片（風格似閱讀前哨站類分享）系統講「做筆記」+「寫讀書心得」兩階段方法。做筆記用「節錄評論法」（抄原文+頁數+評論）+「一問一答法」（為什麼想讀／一句話總結／推薦給誰）；寫作用「由下而上」流程（從筆記浮現主題、不從大綱開始）+「萬能寫作框架」（觀點+案例+總結三段）。核心心法翻轉傳統：先記錄後思考、用自己的話闡述、發展自己想法、筆記本身就是寫作。"
stage: evergreen
icon: "🧠"
---
...
<p align="center"><img src="assets/covers/2026-05-17-yt-note-taking-writing-methods-cover.png" alt="封面圖" width="400"></p>
