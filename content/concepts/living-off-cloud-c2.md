...
<p align="center"><img src="assets/covers/living-off-cloud-c2-cover.png" alt="封面圖" width="400"></p>
...
- **Cloudflare Tunnel 遷移 C2**：Bandcampro 案中，Gemini CLI 在 VPS 啟動新 C2 後建立 Cloudflare Tunnel，並自行修正連線所需標頭；合法隧道服務讓攻擊者在舊 IP／網域被封鎖後快速恢復通訊。
