...
- **pathos 要挖第二層真實情緒**：不是套通用勵志話，是對位真正動心的那句——「我怕失敗」的第二層是「我投入太多、不敢承認自己走錯路」（對應 [[minerva-hc]] 的 #詮釋視角）。Hormozi 從數千通銷售錄音提煉，不靠直覺猜。
...
- Simon 工作場景：寫 MBO 論述、ISO 說明、對 Sam 提報、Substack 文章時，交付前檢查三支柱齊不齊——初稿多半只有 logos（邏輯／數據），補 pathos（為什麼該在乎）＋ethos（憑什麼信）才讓人行動、不只點頭。是 `opinion-piece`／`presentation-design` 工作對外提報文體的內核。
- 一般場景：任何「內容好但轉換率低」——課程宣傳、業務提案、募款、政策推廣、健康衛教。

## 相關概念

- [[curse-of-knowledge]]：說服的另一支——順序與詞畫面對了，非專家才接得住三支柱。
- [[pyramid-principle]]：logos 那一支的骨架（結論先行、3-5 支撐論點）。
- `opinion-piece`、`presentation-design`：本三支柱是它們的方法內核。
- [[minerva-hc]]：對應 76 HC 的 #說服技巧／#詮釋視角／#制定策略／#受眾；本概念由《AI 超級大腦》CH4 的 4-5 帶出。

## 尚未解決的疑問

- 三支柱的比重怎麼配（何時該重 pathos、何時重 ethos），依受眾覺察階段而定，課程只給方向沒給配法。
